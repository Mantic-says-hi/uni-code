 ...
 *  AUTHOR: Connor Beardsmore - 15504319 (Modified slightly by Matthew Matar)
 *  UNIT: DSA120 Prac 8
...
//---------------------------------------------------------------------------
        ...
        try {
            iNumTests++;
            ll = new DSADoubleList();
            System.out.print("Testing creation of DSADoubleList (isEmpty()): ");
            if (ll.isEmpty() == false)
